  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-4 print:bg-white print:text-black">
        ...
        {/* PhilHealth-style sheet */}
        <div className="bg-white text-black p-6 rounded shadow print:shadow-none print:p-0">
          ...
          <div className="text-xs space-y-1 mb-3">
            ...
            <div>Address: {rx.address || "__________________________________"}</div>
            <div>Diagnosis: {rx.diagnosis || "________________________________"}</div>
            <div>PhilHealth PIN: {rx.pin || "______________________"}</div>
          </div>
